...
export default function App() {
  const {
    nodes, edges, onNodesChange, onEdgesChange, project,
    addSectionNode, updateNodeStatus,
  } = useWorkstationStore()
  ...
  // Wire up onConnect so users can manually draw FlowEdges (dashed blue)
                ...
                <div style={{
                  ...
                  <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
                    ...
                    >
                      ...
                      {/* Phase swim lanes — positioned relative to canvas */}
                      <ColumnLabels />
                    ...
                    {/* ── Column Labels overlay (positioned absolutely over ReactFlow) ── */}
                    {project && (
                      <div style={{
                        position: 'absolute',
